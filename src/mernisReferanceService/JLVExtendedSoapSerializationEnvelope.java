...
public class JLVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JLVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JLVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JLVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JLVDateTimeConverter dateTimeConverter = new JLVStandardDateTimeConverter();

    public JLVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JLVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JLVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JLVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JLVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JLVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }

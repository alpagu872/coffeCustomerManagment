...
public class JLVKPSPublicSoap
{
    ...
    public JLVKPSPublicSoap(){}

    public JLVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JLVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JLVExtendedSoapSerializationEnvelope envelope= new JLVExtendedSoapSerializationEnvelope(JLVExtendedSoapSerializationEnvelope.VER11);
